...
const NAV_ITEM_BASE =
  'ui-focus relative flex w-full items-center gap-3 rounded-[1.2rem] px-4 py-3 text-left transition-colors min-h-11 overflow-hidden';
...
const DesktopNavItem = memo(({
  ...
  >
    ...
    <span
      className={cx(
        'relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border transition-colors',
        active
